...
Put the executable file of GRP DECOMPILER to GRP DECOMPILER SHELL directory before first start.
...
0.5 - Bug with file names with space fixed.
0.6 - Program totally rewrote.
0.7 - Russian localization removed. Small changes in source code.
0.8 - Small changes in source code.
0.9 - Small changes. Windows 9x support dropped.
1.0 - User interface improved.
1.0.1 - 1.0.4 - Small changes.
1.0.5 - Program adapted to new version of GRP DECOMPILER.
1.0.6 - Small changes.
1.0.7 - Small bug fixed.
1.0.8 - Small changes.
1.0.8.1 - Documentation updated.
1.0.9 - 1.1.1 - Small changes.
